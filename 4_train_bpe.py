...
# print(f"Loaded {len(en_hi_texts)} English-Hindi pairs")

# # english-bengali pairs  
# en_bn_texts, bn_texts = load_translation_data('data/processed/eng2bengali_train.jsonl')
# print(f"Loaded {len(en_bn_texts)} English-Bengali pairs")

# # concat english texts for tokenizer training
# all_english_texts = en_hi_texts + en_bn_texts
# print(f"Total English texts for tokenizer training: {len(all_english_texts)}")

# # english tokenizer training
# VOCAB_SIZE = 30_000
# MAX_LENGTH = 1024

# # print("\n" + "="*60)
# print("Training SHARED English BPE tokenizer...")
# print("="*60)
...
# print("\n" + "="*60)
# print("Training Bengali BPE tokenizer...")
# print("="*60)
